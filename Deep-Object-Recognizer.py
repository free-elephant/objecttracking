from ctypes import *
import math, random, os, cv2, time

# For Math Calculations, Random Numbers, Read/Write Files(System), OpenCV(Vision Algorithms) and Time Modules(Calculating FPS) Respectively
...
Q_Mat = [744.447, 382.610, 744.447,
         223.1097]  # fx, cx, fy, cy of Q_Matrix from Calibration File - Refer Previous Q - Matrix Values
...
if __name__ == "__main__":
    ...
    try:
        while True:
            ...
            color_frame = pipe.wait_for_frames()
